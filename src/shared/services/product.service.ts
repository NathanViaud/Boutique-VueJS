import type { FiltersInterface, ProductFormInterface, ProductInterface } from "@/shared/interfaces";
import { ref, type Ref } from "vue";

const API_URL = 'https://restapi.fr/api/vueprojectproducts2'

export async function fetchProductsWithFilter(filter: FiltersInterface, page: number): Promise<ProductInterface[] | ProductInterface> {
