<template>
    <div class="p-20 d-flex flex-column">
        ...
        <section class="mb-20">
            ...
            <div class="mb-5" v-for="priceRange of [[0, 10000], [800, 1000], [1000, 1500], [1500, 2000], [2000, 10000]] as [number, number][]" >
                ...
                <label :for="priceRange[0] + ''">{{
                    priceRange[0] === 0 ? 'Tous les prix' : priceRange[0] === 2000 ? 'Plus de 2000€' : `Entre ${ priceRange[0] }€ et ${ priceRange[1] }€`
                }}</label>
            </div>
        </section>
        ...
        <small  class="mb-5">Nombre de résultat: <strong> {{ nbOfProducts }} </strong> </small>
